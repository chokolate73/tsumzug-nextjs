...
export default function ServiceAreasSectionEn() {
      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          duration: 0.8
            ...
            <span className="text-orange-500 font-semibold tracking-wide uppercase text-sm">Service Area</span>
            ...
            <p className="text-slate-600 mt-6 text-lg leading-relaxed">
              With our headquarters in Duisburg, we serve the entire state of North Rhine-Westphalia.
              Whether you're moving within a city or across NRW – we're here for you!
            </p>
            ...
            delay: 0.6
              ...
              <p className="text-slate-600">
                <span className="font-semibold text-slate-900">Don't see your city?</span> No problem!
                We also serve all other cities and communities in NRW.
