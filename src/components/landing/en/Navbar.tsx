...
export default function NavbarEn() {
  ...
  const currentLang = languages.find(l => l.path === '/en') || languages[1];
                ...
                <DropdownMenuContent align="start" className="w-56">
                  {services.map((service) => (
                    <DropdownMenuItem key={service.id} asChild>
                      <Link 
                        to={`/en/services/${service.slug.en}`}
            ...
            <div className="container mx-auto px-6 py-6">
              <div className="flex flex-col gap-4">
                ...
                <div className="border-l-2 border-orange-200 pl-4">
                  <span className="text-sm font-semibold text-slate-500 uppercase tracking-wide">Services</span>
