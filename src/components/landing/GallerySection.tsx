...
const galleryImages: GalleryImage[] = [
  {
    ...
    alt: "Mitarbeiter mit Umzugskartons",
    category: "Umzüge"
  },
  {
    src: galleryMoversFurniture,
    alt: "Möbelträger bei der Arbeit",
    category: "Umzüge"
  },
  {
...
export default function GallerySection() {
  ...
  const categories = ["Alle", "Umzüge", "Transport", "Service"];
  ...
  return (
    <section id="gallery" className="py-16 sm:py-20 md:py-24 bg-slate-50">
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          <span className="text-orange-500 font-semibold tracking-wide uppercase text-xs sm:text-sm">Galerie</span>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mt-3 sm:mt-4 leading-tight">
            Einblicke in
            <span className="text-slate-400"> unsere Arbeit</span>
          </h2>
          <p className="text-slate-600 mt-4 sm:mt-6 text-base sm:text-lg">
            Überzeugen Sie sich selbst von unserer professionellen Arbeit.
          </p>
        </motion.div>
