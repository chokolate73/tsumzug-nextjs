...
const galleryImages: GalleryImage[] = [
  {
    ...
    alt: "Сотрудник с коробками для переезда",
    category: "Переезды"
  },
  {
  ...
  },
  {
    ...
    alt: "Фургон для доставки",
    category: "Транспорт"
  },
  {
    src: galleryTruckWorker,
    alt: "Работник у грузовика",
    category: "Транспорт"
  },
  {
...
export default function GallerySectionRu() {
  ...
  return (
    <section id="gallery" className="py-24 bg-slate-50">
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          <span className="text-orange-500 font-semibold tracking-wide uppercase text-sm">Галерея</span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mt-4 leading-tight">
            Взгляд на
            <span className="text-slate-400"> нашу работу</span>
          </h2>
          <p className="text-slate-600 mt-6 text-lg">
            Убедитесь сами в качестве нашей профессиональной работы.
          </p>
        </motion.div>
