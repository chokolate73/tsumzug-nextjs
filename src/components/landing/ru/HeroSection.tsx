    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-12 relative z-10">
        <div className="max-w-2xl py-12 sm:py-16 md:py-20">
          ...
          >
            Переезд без стресса в Дуйсбурге и NRW
          </motion.h1>
          ...
          >
            Быстрые и надёжные услуги по переезду по всей Северной Рейн-Вестфалии.
          </motion.p>
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-slate-700 font-medium text-sm sm:text-base md:text-lg">Без скрытых платежей</span>
            </div>
            <div className="flex items-center gap-2 sm:gap-3">
              <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-green-600 flex-shrink-0" />
              <span className="text-slate-700 font-medium text-sm sm:text-base md:text-lg">1500+ переездов</span>
            </div>
            <div className="flex items-center gap-2 sm:gap-3">
              <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-green-600 flex-shrink-0" />
              <span className="text-slate-700 font-medium text-sm sm:text-base md:text-lg">7+ городов</span>
            </div>
          </motion.div>
        </div>
      </div>
