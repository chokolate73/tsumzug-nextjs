...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    location: "Кёльн",
    rating: 5,
    text: "Пользовался разными компаниями по переезду, но TopSicher Umzüge — лучшие. Профессиональная упаковка, без повреждений, честные цены. При следующем переезде обращусь снова!",
    service: "Квартирный переезд",
    date: "Сентябрь 2024"
  },
  {
