...
import { Phone, Mail, MapPin, Facebook, ArrowUp, Navigation } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          ...
          >
            ...
            <p className="text-slate-400 leading-relaxed text-sm sm:text-base">
              Professionelle Umzugs- und Transportdienstleistungen in Duisburg und ganz Nordrhein-Westfalen.
            </p>
          ...
          >
            <h4 className="text-base sm:text-lg font-semibold mb-4 sm:mb-6">Kontakt</h4>
            <ul className="space-y-3 sm:space-y-4">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg transition-colors text-sm font-medium mt-2"
                >
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
            <div className="flex flex-wrap items-center gap-2 sm:gap-4">
              <p className="text-slate-500 text-xs sm:text-sm text-center sm:text-left">
                © {currentYear} TopSicher Umzüge. Alle Rechte vorbehalten.
              </p>
