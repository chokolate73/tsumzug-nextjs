        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <Link href="/umzugsunternehmen-duisburg" className="font-medium text-slate-600 hover:text-slate-900 transition-colors">Leistungen</Link>
              <Link href="/umzug-kosten-duisburg" className="font-medium text-slate-600 hover:text-slate-900 transition-colors">Preise</Link>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white shadow-2xl rounded-b-3xl">
            <div className="container mx-auto px-6 py-6 flex flex-col gap-4">
              ...
              <Link href="/umzugsunternehmen-duisburg" className="text-lg font-medium text-slate-700 py-2">Leistungen</Link>
              <Link href="/umzug-kosten-duisburg" className="text-lg font-medium text-slate-700 py-2">Preise</Link>
              ...
              <div className="bg-slate-900 rounded-3xl p-8 text-white sticky top-24">
                ...
                <div className="mt-8 pt-8 border-t border-slate-700">
                  ...
                  <ul className="space-y-2 text-sm text-slate-400">
                    <li><Link href="/privatumzug-duisburg" className="hover:text-orange-400">Privatumzüge</Link></li>
                    <li><Link href="/firmenumzug-duisburg" className="hover:text-orange-400">Firmenumzüge</Link></li>
                    <li><Link href="/entruempelung-duisburg" className="hover:text-orange-400">Entrümpelung</Link></li>
                    <li><Link href="/haushaltsaufloesung-duisburg" className="hover:text-orange-400">Haushaltsauflösung</Link></li>
                    <li><Link href="/moebeltransport-duisburg" className="hover:text-orange-400">Möbeltransport</Link></li>
                  </ul>
                </div>
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <Link href="/impressum" className="text-slate-400 hover:text-orange-400 text-sm">Impressum</Link>
              <Link href="/datenschutz" className="text-slate-400 hover:text-orange-400 text-sm">Datenschutz</Link>
            </div>
          </div>
        </div>
      </footer>
