        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">
              Unsere Preise für Hausmeisterservice
            </h2>
            <p className="text-slate-600 mb-10 max-w-2xl">
              Faire und transparente Preise für alle handwerklichen Leistungen.
            </p>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <h3 className="text-lg font-bold text-slate-900 mb-2">Stundensatz</h3>
              <div className="text-3xl font-bold text-orange-500 mb-1">ab 35 &euro;</div>
              <p className="text-sm text-slate-500">pro Stunde</p>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl p-6 text-center border border-slate-100"
            >
              <h3 className="text-lg font-bold text-slate-900 mb-2">Monatspauschale</h3>
              <div className="text-3xl font-bold text-orange-500 mb-1">ab 250 &euro;</div>
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl p-6 text-center border border-slate-100"
            >
              <h3 className="text-lg font-bold text-slate-900 mb-2">Notdienst</h3>
              <div className="text-3xl font-bold text-orange-500 mb-1">ab 89 &euro;</div>
              <p className="text-sm text-slate-500">Soforteinsatz</p>
            </motion.div>
          </div>
