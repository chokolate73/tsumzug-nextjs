        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center gap-6">
              <Link href="/ru" className="font-medium text-slate-600 hover:text-slate-900 transition-colors">
                Главная
              </Link>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white shadow-2xl rounded-b-3xl">
            <div className="container mx-auto px-6 py-6 flex flex-col gap-4">
              <Link href="/ru" className="text-lg font-medium text-slate-700 py-2">Главная</Link>
      ...
      <div className="pt-24 bg-slate-100">
        <div className="container mx-auto px-6 md:px-12 py-3">
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm text-slate-600">
            <Link href="/ru" className="flex items-center gap-1 hover:text-orange-500 transition-colors">
      ...
      <section className="pt-8 pb-16 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <Link href="/ru" className="inline-flex items-center gap-2 text-orange-400 hover:text-orange-300 transition-colors mb-6">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/ru/services/chastnye-pereezdy" className="text-slate-400 hover:text-orange-400 transition-colors">Частные переезды</Link></li>
                <li><Link href="/ru/services/ofisnye-pereezdy" className="text-slate-400 hover:text-orange-400 transition-colors">Офисные переезды</Link></li>
                <li><Link href="/ru/services/uborka-vyvoz" className="text-slate-400 hover:text-orange-400 transition-colors">Уборка и вывоз</Link></li>
                <li><Link href="/ru/services/perevozka-mebeli" className="text-slate-400 hover:text-orange-400 transition-colors">Перевозка мебели</Link></li>
                <li><Link href="/ru/services/uslugi-masterov" className="text-slate-400 hover:text-orange-400 transition-colors">Услуги мастеров</Link></li>
                <li><Link href="/ru/services/remont" className="text-slate-400 hover:text-orange-400 transition-colors">Ремонт</Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/impressum" className="text-slate-400 hover:text-orange-400 transition-colors">Импрессум</Link></li>
                <li><Link href="/datenschutz" className="text-slate-400 hover:text-orange-400 transition-colors">Политика конфиденциальности</Link></li>
              </ul>
            </div>
          </div>
