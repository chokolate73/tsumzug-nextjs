        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center gap-6">
              <Link to="/" className="font-medium text-slate-600 hover:text-slate-900 transition-colors">
                Home
              </Link>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              <Button size="lg" className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-6 text-lg rounded-xl" asChild>
                <Link to={`/angebot${ANGEBOT_UTM}`} onClick={() => trackAngebotClick('hero_cta')}><Calculator className="mr-2 w-5 h-5" />Kostenloses Angebot</Link>
              </Button>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/privatumzug-duisburg" className="text-slate-400 hover:text-orange-400 transition-colors">Privatumzug</Link></li>
                <li><Link to="/firmenumzug-duisburg" className="text-slate-400 hover:text-orange-400 transition-colors">Firmenumzug</Link></li>
                <li><Link to="/entruempelung-duisburg" className="text-slate-400 hover:text-orange-400 transition-colors">Entrümpelung</Link></li>
                <li><Link to="/moebeltransport-duisburg" className="text-slate-400 hover:text-orange-400 transition-colors">Möbeltransport</Link></li>
                <li><Link to="/hausmeisterservice-duisburg" className="text-slate-400 hover:text-orange-400 transition-colors">Hausmeisterservice</Link></li>
                <li><Link to="/renovierung-duisburg" className="text-slate-400 hover:text-orange-400 transition-colors">Renovierung</Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/impressum" className="text-slate-400 hover:text-orange-400 transition-colors">Impressum</Link></li>
                <li><Link to="/datenschutz" className="text-slate-400 hover:text-orange-400 transition-colors">Datenschutz</Link></li>
              </ul>
            </div>
          </div>
