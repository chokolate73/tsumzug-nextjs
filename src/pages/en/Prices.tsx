      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md shadow-sm">
        <div className="container mx-auto px-6 md:px-12">
          <div className="flex items-center justify-between h-20">
            <Link to="/en" className="text-xl font-bold">
              <span className="text-slate-900">TopSicher</span>
              <span className="text-orange-500"> Umzüge</span>
            </Link>

            <div className="hidden md:flex items-center gap-6">
              <Link to="/en" className="font-medium text-slate-600 hover:text-slate-900 transition-colors">
                Home
              </Link>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white shadow-2xl rounded-b-3xl">
            <div className="container mx-auto px-6 py-6 flex flex-col gap-4">
              <Link to="/en" className="text-lg font-medium text-slate-700 py-2">Home</Link>
      ...
      <div className="pt-24 bg-slate-100">
        <div className="container mx-auto px-6 md:px-12 py-3">
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm text-slate-600">
            <Link to="/en" className="flex items-center gap-1 hover:text-orange-500 transition-colors">
      ...
      <section className="pt-8 pb-16 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <Link to="/en" className="inline-flex items-center gap-2 text-orange-400 hover:text-orange-300 transition-colors mb-6">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/en/services/residential-moves" className="text-slate-400 hover:text-orange-400 transition-colors">Residential Moves</Link></li>
                <li><Link to="/en/services/office-relocations" className="text-slate-400 hover:text-orange-400 transition-colors">Office Relocations</Link></li>
                <li><Link to="/en/services/clearance-disposal" className="text-slate-400 hover:text-orange-400 transition-colors">Clearance & Disposal</Link></li>
                <li><Link to="/en/services/furniture-transport" className="text-slate-400 hover:text-orange-400 transition-colors">Furniture Transport</Link></li>
                <li><Link to="/en/services/handyman-services" className="text-slate-400 hover:text-orange-400 transition-colors">Handyman Services</Link></li>
                <li><Link to="/en/services/renovation" className="text-slate-400 hover:text-orange-400 transition-colors">Renovation</Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/impressum" className="text-slate-400 hover:text-orange-400 transition-colors">Imprint</Link></li>
                <li><Link to="/datenschutz" className="text-slate-400 hover:text-orange-400 transition-colors">Privacy Policy</Link></li>
              </ul>
            </div>
          </div>
